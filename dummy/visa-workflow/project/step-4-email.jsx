...
const Step4Email = ({ docDates, emailConfig, onNext, onBack }) => {
    ...
    <>
      ...
      <div className="email-paper">
        <dl className="email-headers">
          <dt>To</dt><dd>{emailConfig.to}</dd>
          <dt>Cc</dt><dd>{emailConfig.cc}</dd>
          <dt>Subject</dt><dd className="subject">{subject}</dd>
        </dl>
...
${emailConfig.signoff}`}
      ...
      <div className="btn-row between">
        ...
        <button className="btn btn-primary" onClick={onNext}>I'll review in Gmail →</button>
      </div>
    </>
  );
};
