...
const Step5Done = ({ emailConfig, onSent, sent, onReset }) => {
  return (
    <>
      <StepHead
        eyebrow="Step 5 · Final"
        title={sent ? <>Session <em>closed</em></> : <>Awaiting <em>your send</em></>}
        desc={sent
      ...
      <div className="summary-card">
        ...
        <h2 className="summary-big">
          {sent ? <><em>Visa-May-2026</em> wrapped</> : <>Almost <em>there</em></>}
        </h2>
      ...
      {!sent ? (
        <>
          <div className="notice">
            ...
            <div>
              Sending the draft is a one-click manual step in Gmail. Once you've sent it, click below to record the submission, move files into the root folder, and start fresh.
            </div>
          </div>

          <div className="btn-row between">
            <a className="btn btn-sm" href="#" onClick={e => e.preventDefault()}>↗ Open Gmail Drafts</a>
