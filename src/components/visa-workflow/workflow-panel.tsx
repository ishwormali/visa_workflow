  ...
  return (
    <section className="panel overflow-hidden p-6 sm:p-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="text-xs tracking-[0.24em] text-muted-foreground uppercase">Workflow</p>
          ...
          <section className="rounded-[1.75rem] border border-border/70 bg-card/80 p-5">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <h3 className="mt-1 font-heading text-xl font-semibold">Choose workflow dates</h3>
                <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
                  In settings, connect Drive and choose the root folder. Here, only pick the date
                  range for this run.
                </p>
              </div>
    ...
    <div className="mt-8 grid gap-3 sm:grid-cols-2">
      {STEP_ITEMS.map((step) => {
        ...
        return (
          ...
          >
            <p className="text-xs tracking-[0.24em] uppercase">Step {step.id}</p>
